...
vertices :: []Vertex {
    {{-0.5, -0.5, 0}, {1, 0, 0}, {0, 0}}, // top left
    {{-0.5, 0.5, 0}, {0, 1, 0}, {0, 512}}, // bottom left
    {{0.5, -0.5, 0}, {0, 0, 1}, {512, 0}}, // top right
    {{0.5, 0.5, 0}, {0.3, 0.3, 0.3}, {512, 512}}, // bottom right
    {{0, 0, 0.1}, {1, 0, 0}, {0, 0}}, // top left
    {{0, 1, 0.1}, {0, 1, 0}, {0, 512}}, // bottom left
    {{1, 0, 0.1}, {0, 0, 1}, {512, 0}}, // top right
    {{1, 1, 0.1}, {0.3, 0.3, 0.3}, {512, 512}}, // bottom right
}
