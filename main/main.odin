...
vertices :: []Vertex {
    // A
    {{-0.5, -0.5, z1}, {0, 0, 0, 0}, {0, 0}},
    {{-0.5, 0.5, z1}, {0, 0, 0, 0}, {0, 16}},
    {{0.5, -0.5, z1}, {0, 0, 0, 0}, {8, 0}},
    {{0.5, 0.5, z1}, {0, 0, 0, 0}, {8, 16}},
    // B
    {{0, 0, z2}, {0, 0, 0, 0}, {8, 0}},
    {{0, 1, z2}, {0, 0, 0, 0}, {8, 16}},
    {{1, 0, z2}, {0, 0, 0, 0}, {16, 0}},
    {{1, 1, z2}, {0, 0, 0, 0}, {16, 16}},
    // C -> RGBW
    {{-0.25, -0.25, z3}, {1, 0, 0, 1}, {16, 0}},
    {{-0.25, 0.75, z3}, {0, 1, 0, 1}, {16, 16}},
    {{0.75, -0.25, z3}, {0, 0, 1, 1}, {24, 0}},
    {{0.75, 0.75, z3}, {1, 1, 1, 1}, {24, 16}},
}
