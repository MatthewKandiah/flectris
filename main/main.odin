...
vertices :: []Vertex {
    ...
    {{-0.5, 0.5, z1}, {0, 1, 0}, {0, 16}}, // bottom left
    {{0.5, -0.5, z1}, {0, 0, 1}, {8, 0}}, // top right
    {{0.5, 0.5, z1}, {0.3, 0.3, 0.3}, {8, 16}}, // bottom right
    {{0, 0, z2}, {1, 0, 0}, {8, 0}}, // top left
    {{0, 1, z2}, {0, 1, 0}, {8, 16}}, // bottom left
    {{1, 0, z2}, {0, 0, 1}, {16, 0}}, // top right
    {{1, 1, z2}, {0.3, 0.3, 0.3}, {16, 16}}, // bottom right
    {{-0.25, -0.25, z3}, {1, 0, 0}, {16, 0}}, // top left
    {{-0.25, 0.75, z3}, {0, 1, 0}, {16, 16}}, // bottom left
    {{0.75, -0.25, z3}, {0, 0, 1}, {24, 0}}, // top right
    {{0.75, 0.75, z3}, {0.3, 0.3, 0.3}, {24, 16}}, // bottom right
}
